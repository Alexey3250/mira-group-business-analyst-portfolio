  ...
  return (
    <div className="grid gap-5">
      <section className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
        <Panel title="RFQ pipeline" eyebrow="Request to contract" icon={Filter}>
        ...
        <Panel title="Conversion rates by product family" eyebrow="Product-level funnel" icon={Layers3}>
          <ChartFrame className="h-[338px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={productConversion} margin={{ top: 12, right: 18, left: 0, bottom: 8 }}>
                <defs>
                ...
                <XAxis dataKey="product" tick={{ fontSize: 12 }} interval={0} height={54} />
      ...
      <section className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
        <Panel title="Counterparty channel performance" eyebrow="Top 10 by volume" icon={Handshake}>
          <ChartFrame className="h-[390px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={counterpartyChannels}
                layout="vertical"
        ...
        <Panel title="Destination market heatmap" eyebrow="Bulk trading demand signal" icon={Globe2}>
          <div className="grid grid-cols-2 gap-3">
            {destinationGeography.map((market) => (
              <div
                key={market.market}
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                  <Stat label="RFQs" value={market.leads.toString()} />
